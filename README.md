...
Pack NotebookLM flashcards and quizzes into Anki-ready CSV.

Satchel is a Chrome extension for [Gemini Notebook](https://notebook.google.com/) (formerly NotebookLM). It adds **Copy CSV** and **Download CSV** to the Studio flashcard and quiz viewers so you can import cards into Anki. Extraction runs in your browser. Nothing is uploaded.
...
4. Open a notebook, generate flashcards or a quiz, and use the Satchel bar

For live reload while developing: `npm run dev`.

If the bar does not appear, open the flashcard or quiz viewer, click **Scan this tab** in the popup, and reload the notebook after installing or updating.
